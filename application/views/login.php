	        ...
	        <div class="col-md-4 col-md-offset-4">
	            <div class="login-panel panel panel-default">
	                <div class="panel-heading">
	                    <h3 class="panel-title">Luckadmin Panel- Area de login</h3>
	                </div>
	                <div class="panel-body">
	                	<small id="login-empty-input" class="error">E-mail e senha não podem estar vazios <br>&nbsp;</small>
	                	<?php if($alert): ?>
	                		<small id="login-invalid-input" class="error">Email inválido ou senha incorreta<br>&nbsp;</small>
	                	<?php endif; ?>
	                    ...
	                    <form role="form" method="post" onsubmit="return checkEmptyInput();" action="<?=base_url()?>/authentication/login/">
	                        <fieldset>
	                            ...
	                            <div class="form-group">
	                                <small><a href="#" onclick="alert('Contate ao administrador para resetar a senha!')">Esqueci a senha</a></small>
	                            </div>
